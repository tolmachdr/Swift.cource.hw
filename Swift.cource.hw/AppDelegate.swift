...
//
    ...
    func createFetchedResultsController() -> NSFetchedResultsController<CharacterModule> {
        let fetchRequest: NSFetchRequest<CharacterModule> = CharacterModule.fetchRequest()
        let sortDescriptor = NSSortDescriptor(key: "name", ascending: true)
        fetchRequest.sortDescriptors = [sortDescriptor]
        
        let fetchedResultsController = NSFetchedResultsController<NSFetchRequestResult>(fetchRequest: fetchRequest,
